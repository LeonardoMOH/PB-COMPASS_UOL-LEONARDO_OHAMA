...
# Exporta todas as tabelas dimensao e fato em formato Parquet

output_path = "C:/GitHub/PB-COMPASS_UOL-LEONARDO_OHAMA/Sprint 10/Desafio/parquet/LOCAL/"

dim_titulo.write.mode("overwrite").parquet(output_path + "dim_titulo.parquet")
dim_ano.write.mode("overwrite").parquet(output_path + "dim_ano.parquet")
dim_mes.write.mode("overwrite").parquet(output_path + "dim_mes.parquet")
dim_dia.write.mode("overwrite").parquet(output_path + "dim_dia.parquet")
