...
dim_tempo_dyf = DynamicFrame.fromDF(dim_tempo, glueContext, "dim_tempo")
...
glueContext.write_dynamic_frame.from_options(dim_tempo_dyf, connection_type="s3", connection_options={"path": output_path + "dimtempo/dim_tempo/"}, format="parquet")
