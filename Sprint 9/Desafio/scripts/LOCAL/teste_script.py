...
parquet_1 = "C:/GitHub/duck_db/parquet/GLUE/part-00000-32f41a81-2c46-47c9-8a60-514577dccd56-c000.snappy.parquet"
parquet_2 = "C:/GitHub/duck_db/parquet/GLUE/part-00000-74d09563-078f-4d10-ac04-b4953011ffe5-c000.snappy.parquet"
...
# Criar a tabela dimensao titulo mantendo apenas um id_filme por titulo
...
# Criar ID unico para cada titulo (com base no id_filme correto)
...
# Explosao da coluna genero para criar uma tabela auxiliar

df_genero = df_filme.select("id_filme", explode(split(col("genero"), ",")).alias("genero"))

# Criar uma lista unica de generos com IDs consistentes
...
# Criar tabela de associacao filme-genero (bridge)
...
# Criar a tabela dim_tempo apenas com as datas presentes na tabela fato
...
# Extrair ano, mes e dia da coluna data_lancamento
